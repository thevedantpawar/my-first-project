...
``require_staff``
    Front-desk/dentist staff reading dashboards and patient-level data.
Public
...
def require_staff(
    ...
    """Authenticate a front-desk/dentist caller.

    A shared token is the right size of solution for a single-practice
